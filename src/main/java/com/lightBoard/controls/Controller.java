...
//	    	canvas.widthProperty().bind(canvasHBox.widthProperty());
	...
	public void selectPatternHeaderImage()
	{
		...
		fileChooser.setInitialDirectory(FileLoader.loadFolder(mControls.getDefaultImageRoot()));
	...
	public void selectPatternSound()
	{
		...
		fileChooser.setInitialDirectory(FileLoader.loadFolder(mControls.getDefaultSoundRoot()));
